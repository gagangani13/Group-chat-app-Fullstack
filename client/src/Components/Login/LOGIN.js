...
const LOGIN = () => {
  ...
  return (
    <>
      <div id="webpage"></div>
      <div>
        <motion.h1 initial={{opacity:0}} animate={{opacity:1,}} transition={{repeat:Infinity,repeatType:"reverse",duration:3,type:'spring'}} id="loginH1">Chat App</motion.h1>
        <motion.div initial={{y:'100vh'}} animate={{y:0}} transition={{stiffness:100,type:'tween',duration:1}} className="layout">
